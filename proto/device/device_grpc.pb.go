...
const (
	...
	DeviceService_GetDeviceStat_FullMethodName = "/onepark.device.DeviceService/GetDeviceStat"
)
...
type DeviceServiceClient interface {
	...
	GetDeviceStat(ctx context.Context, in *GetDeviceStatReq, opts ...grpc.CallOption) (*GetDeviceStatResp, error)
}
...
func (c *deviceServiceClient) GetDeviceStat(ctx context.Context, in *GetDeviceStatReq, opts ...grpc.CallOption) (*GetDeviceStatResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDeviceStatResp)
	err := c.cc.Invoke(ctx, DeviceService_GetDeviceStat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServiceServer interface {
	...
	// GetDeviceStat 设备数量统计, 供 M5 dashboard-service 大屏计算在线率(清单 #69 / #72).
	// 注意: 返回的是"统计数", 不是设备列表 —— 大屏只需要台数, 避免全量拉取后在消费方计数.
	GetDeviceStat(context.Context, *GetDeviceStatReq) (*GetDeviceStatResp, error)
...
func (UnimplementedDeviceServiceServer) GetDeviceStat(context.Context, *GetDeviceStatReq) (*GetDeviceStatResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDeviceStat not implemented")
}
...
func _DeviceService_GetDeviceStat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDeviceStatReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).GetDeviceStat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_GetDeviceStat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).GetDeviceStat(ctx, req.(*GetDeviceStatReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeviceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDeviceStat",
			Handler:    _DeviceService_GetDeviceStat_Handler,
		},
	},
