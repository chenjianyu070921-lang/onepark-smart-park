...
type ListWorkOrdersResp struct {
	...
	TodayCount        int64                  `protobuf:"varint,4,opt,name=today_count,json=todayCount,proto3" json:"today_count,omitempty"`                         // 今日新建工单数(按 created_at 当天)
	CompletedToday    int64                  `protobuf:"varint,5,opt,name=completed_today,json=completedToday,proto3" json:"completed_today,omitempty"`             // 今日完成(已完成状态)工单数
	AvgProcessMinutes float64                `protobuf:"fixed64,6,opt,name=avg_process_minutes,json=avgProcessMinutes,proto3" json:"avg_process_minutes,omitempty"` // 已完成工单平均处理时长(分钟)
	CompletionRate    float64                `protobuf:"fixed64,7,opt,name=completion_rate,json=completionRate,proto3" json:"completion_rate,omitempty"`            // 完成率(0~100, 已完成/总数)
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ListWorkOrdersResp) GetTodayCount() int64 {
	if x != nil {
		return x.TodayCount
	}
	return 0
...
func (x *ListWorkOrdersResp) GetCompletedToday() int64 {
	if x != nil {
...
func (x *ListWorkOrdersResp) GetAvgProcessMinutes() float64 {
	if x != nil {
		return x.AvgProcessMinutes
	}
	return 0
}

func (x *ListWorkOrdersResp) GetCompletionRate() float64 {
	if x != nil {
...
const file_workorder_workorder_proto_rawDesc = "" +
	...
	"assigneeId\x12\x1d\n" +
	"\n" +
	"created_at\x18\a \x01(\x03R\tcreatedAt\"\xab\x02\n" +
	...
	"\rpending_count\x18\x03 \x01(\x03R\fpendingCount\x12\x1f\n" +
	"\vtoday_count\x18\x04 \x01(\x03R\n" +
	"todayCount\x12'\n" +
	"\x0fcompleted_today\x18\x05 \x01(\x03R\x0ecompletedToday\x12.\n" +
	"\x13avg_process_minutes\x18\x06 \x01(\x01R\x11avgProcessMinutes\x12'\n" +
	"\x0fcompletion_rate\x18\a \x01(\x01R\x0ecompletionRate2\xa7\x01\n" +
