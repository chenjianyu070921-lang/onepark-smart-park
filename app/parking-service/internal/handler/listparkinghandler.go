...
// ListParkingHandler 停车记录列表 HTTP 处理器.
// 路由: GET /api/parking/records (对外经网关: GET /api/parking/records).
// 职责: 解析查询串(status/plate_no/page/page_size) -> 调 ListParkingLogic 分页 -> 统一响应体.
